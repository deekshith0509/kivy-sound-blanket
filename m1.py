"""
Main.py – Fully Overhauled UI using KivyMD with Fixed Icon Button Property

This application uses Material Design components from KivyMD to create a modern, engaging interface.
It features a top app bar with actions, and two tabs:
    • Sounds Tab displays sound tiles as MDCard widgets with play/pause and volume controls.
    • Mixes Tab lists your saved mixes.
The error regarding the unrecognized property "user_font_size" is fixed by replacing it with "icon_size."
"""
